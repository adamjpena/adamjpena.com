        ...
        <div className="row">
          <div className="col-sm-6 col-sm-push-3 col-xs-8 col-xs-push-2 col-md-4 col-md-push-0 margin-bottom-2x">
            <TransitionOnEnter transition="reveal">
              <div>
                <img src={portrait} srcSet={`${portrait} 481w, ${portrait2x} 962w`} alt="Adam J Pena" className="visible-lte-sm" />
                <img
                ...
                <div className="social-links flex">
                  <a href="https://www.linkedin.com/in/adamjpena" rel="noopener noreferrer" target="_blank">
                    <i className="fa fa-linkedin" />
                  </a>
                  <a href="https://www.github.com/adamjpena" rel="noopener noreferrer" target="_blank">
          ...
          <div className="col-xs-12 col-md-8">
            <TransitionOnEnter transition="grow">
              ...
              <p className="margin-bottom-2x">
                  I take pleasure in streamlining a process to increase productivity and ensure a
                  quality output. In design, this translates to designing intuitive interfaces to
                  make things as easy as drawing in wet sand on a beach. If I&#39;m not behind a
                  screen writing code or producing music, I&#39;m probably learning a new recipe or
                  at the gym.
              </p>
            </TransitionOnEnter>
